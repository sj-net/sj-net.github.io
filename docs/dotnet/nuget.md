...
1. Ensure the .nupkg file contians the pdb file along with the dll.   
    ...
    d. [Reference](https://learn.microsoft.com/en-us/dotnet/standard/library-guidance/nuget#symbol-packages)
2. In the project where you refer the package add below lines in the PropertyGroup.  
    a. `<CopyDebugSymbolFilesFromPackages>true</CopyDebugSymbolFilesFromPackages>`  
    b. `<CopyDocumentationFilesFromPackages>true</CopyDocumentationFilesFromPackages>`  
    c. [Reference](https://learn.microsoft.com/en-us/dotnet/core/project-sdk/msbuild-props)
